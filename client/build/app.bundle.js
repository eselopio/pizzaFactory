...
var _pizzaServiceMock = __webpack_require__(124);
...
var ModuloPizzaFront = function () {
    function ModuloPizzaFront(elements, total) {
        _classCallCheck(this, ModuloPizzaFront);
    ...
    _createClass(ModuloPizzaFront, [{
        key: 'init',
        value: function init() {
            var _this = this;

            Promise.all([this.findIngredients, this.findMasses]).then(function (values) {
                return _this.configFiltros;
            });
        }
    }, {
        key: 'configFiltros',
        value: function configFiltros() {
            var mPizza = this;
            return new Promise(function (resolve, reject) {
                document.addEventListener('DOMContentLoaded', function () {
                    ...
                    multipleDefault.passedElement.addEventListener('addItem', function (event) {
                        var i = (0, _find2.default)(mPizza.listPrices, function (o) {
        ...
        key: 'configSelects',
        value: function configSelects(elements) {
            var select = "";
        ...
        key: 'findIngredients',
        value: function findIngredients() {
            var _this2 = this;

            return services.findAllIngredients().then(function (ingredients) {
                _this2.listPrices = ingredients;
                _this2.totalPizza = 0;
                document.getElementById("choices-multiple-ingredients").innerHTML = _this2.configSelects(ingredients);
        ...
        key: 'findMasses',
        value: function findMasses() {
            var _this3 = this;

            return services.findAllMasses().then(function (masses) {
                document.getElementById("choices-multiple-masses").innerHTML = _this3.configSelects(masses);
            }).catch(function (error) {
                return console.log("error: ", error);
            });
        }
...
var createFind = __webpack_require__(38),
...
module.exports = {
  findAllIngredients: function findAllIngredients() {
    return new Promise(function (resolve) {
      return resolve(ingredients);
    });
  },
  findAllMasses: function findAllMasses() {
    return new Promise(function (resolve) {
      return resolve(masses);
    });
  }
};
